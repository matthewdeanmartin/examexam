...
1. Fork and branch: `feat/…`, `fix/…`, or `docs/…` (Conventional Commits style appreciated).
1. Make focused changes with tests and docs as needed.
1. Run `just check` locally and fix any failures.
1. Push and open a Pull Request on GitHub.
1. Be responsive to review comments; we keep PRs small and iterative.
